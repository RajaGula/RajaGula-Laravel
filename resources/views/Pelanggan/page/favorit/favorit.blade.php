...
<div class="container mt-5 justify-content-center" id="cont">
    <div class="cont">
        <form action="{{ route('favorit.search') }}" method="get" class="input-group mb-3">
            @csrf
            ...
            <table class="table table-responsive table-bordered border-success">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="line-height: 8rem; text-align: center">
                            <center><img src="{{ asset('fotoproduk/' . $fav->produk->foto_produk) }}" alt="foto" class="img-fluid" style="height: 8rem; padding-right: 0;"><center>
                        </td>
                        ...
                        <td style="line-height: 8rem; text-align: center">
                            <center>
                                <a class="btn btn-outline-light" href="{{route('home.view', $fav->produk->id)}}" style="background-color:#7F9B6E; font-color:white; width:40%; border-radius:25px 25px 25px 25px">Detail</a>
